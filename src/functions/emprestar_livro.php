...
// ── empréstimo ativo (igual antes) ───────────────────────────────────────────
$linhaEmp = "ID: $id | Registro: $registro | Aluno: $aluno | Sala: $sala | Retirada: $hoje | Devolucao: $devolucao\n";
file_put_contents($arqEmprestimos, $linhaEmp, FILE_APPEND | LOCK_EX);

// ── histórico permanente ──────────────────────────────────────────────────────
$arqHistorico = $diretorio . '/historico.txt';
if (!file_exists($arqHistorico)) file_put_contents($arqHistorico, "---HISTORICO---\n", LOCK_EX);

$nomelivro   = $livro['nome'];
$linhaHist   = "ID: $id | Registro: $registro | Livro: $nomelivro | Aluno: $aluno | Sala: $sala | Retirada: $hoje | Devolucao: $devolucao | Ano: $ano\n";
